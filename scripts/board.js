...
function renderMobileMoveAction(todo, status) {
  ...
  if (moveTasks.moveTaskUp != null) {
    output += renderMoveButton(
      todo.id,
      moveTasks.moveTaskUp,
      "arrow_upward.svg",
      "arrow up",
    );
  }
...
/**
 * Displays the AI-generated label for a task and updates creator information.
 * If the task was generated by AI, shows the AI badge and sets external creator info.
 * Otherwise, hides the AI badge and sets internal creator info.
 *
 * @param {Object} task - The task object containing metadata such as aiGenerated and creator info.
 */
...
/**
 * Configures the creator badge for tasks created externally (e.g., via email or AI).
 * Updates badge icons, label text, and sets a mailto link for contacting the creator.
 *
 * @param {Object} task - The task object containing creatorEmail and creatorName.
 */
...
/**
 * Configures the creator badge for tasks created internally by JOIN users.
 * Updates badge icons, label text, and links to the creator's profile page.
 *
 * @param {Object} task - The task object containing creatorContactId and creatorName.
 */
...
/**
 * Updates the displayed creator name for a task.
 * Falls back to "Unknown user" if no valid creatorName is provided.
 *
 * @param {Object} task - The task object containing creatorName.
 */
